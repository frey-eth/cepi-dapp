  ...
  return (
    <main className='mx-auto h-full w-full  p-4 pt-10  lg:w-[1288px]'>
      <div className='h-full w-full   lg:min-h-[728px]'>
        <section className='table-custom relative overflow-y-hidden rounded-[16px] border border-solid border-[#43434352] bg-[rgba(255,255,255,0.06)] min-[315px]:h-[450px] min-[375px]:h-[380px] min-[375px]:p-2 min-[414px]:h-[400px] min-[414px]:p-4 md:h-[398px] md:overflow-hidden  md:rounded-2xl md:border-none md:p-6'>
