          ...
          <>
            <Dialog.Title as='div' className='flex w-full items-center font-helveticaNeue'>
              ...
              <div className='flex items-center gap-[16px]'>
                <div className='flex items-center gap-[8px]'>
                  ...
                  <p className='mt-[2px] text-sm font-normal leading-[10px]'>{dData?.walletBalance.toString()} LST</p>
                </div>
                <button
                  onClick={() => {
                    if (balance > 0) {
            ...
            <div className='mt-2'>
              <label className='flex w-full items-center gap-2 rounded-xl border-[0.6px] border-[#FFFFFF14] bg-black p-[12px]'>
                ...
                >
                  <Image src={dData?.assetIcon ?? group} width={32} height={32} alt='image' className='object-cover' />
              ...
              <div className='mt-6 flex w-full flex-col items-center gap-2'>
                <div className='flex w-full items-center gap-4'>
                  <div className='flex flex-1 items-center gap-2'>
                    ...
                    <Image src={info} alt='setting' id='borrow-info' width={16} height={16} className='object-cover' />
                  </div>
            ...
            <div className='mt-6 flex w-full items-center'>
              ...
              >
                ...
                <span className='font-helveticaNeue  text-sm font-normal leading-[14px] text-[#8F9399]'>Setting</span>
              </button>
            </div>
